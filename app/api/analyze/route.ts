...
export async function POST(request: Request) {
  try {
    ...
    if(action==="investigate"){
      ...
      const notes=await specialist(client,assignment[0],assignment[1],context);return Response.json({ok:true,kind,notes,directEvidence:{county,fema}});
    }
